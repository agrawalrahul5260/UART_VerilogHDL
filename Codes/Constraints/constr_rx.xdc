...
## - uncomment the lines corresponding to used pinext_state
...
# LEDs
set_property PACKAGE_PIN U16 [get_ports RxD[0]]					
	set_property IOSTANDARD LVCMOS33 [get_ports RxD[0]]
set_property PACKAGE_PIN E19 [get_ports {RxD[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RxD[1]}]
set_property PACKAGE_PIN U19 [get_ports {RxD[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RxD[2]}]
set_property PACKAGE_PIN V19 [get_ports {RxD[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RxD[3]}]
set_property PACKAGE_PIN W18 [get_ports {RxD[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RxD[4]}]
set_property PACKAGE_PIN U15 [get_ports {RxD[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RxD[5]}]
set_property PACKAGE_PIN U14 [get_ports {RxD[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RxD[6]}]
set_property PACKAGE_PIN V14 [get_ports {RxD[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RxD[7]}]
#set_property PACKAGE_PIN V13 [get_ports {RxD[8]}]					
...
#	set_property IOSTANDARD LVCMOS33 [get_ports reset]
#set_property PACKAGE_PIN T18 [get_ports rx_en]					
...
###Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {tranext_statemit_debug}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {tranext_statemit_debug}]
###Sch name = JA3
...
##USB HID (present_state/2)
#set_property PACKAGE_PIN C17 [get_ports present_state2Clk]						
	#set_property IOSTANDARD LVCMOS33 [get_ports present_state2Clk]
	#set_property PULLUP true [get_ports present_state2Clk]
#set_property PACKAGE_PIN B17 [get_ports present_state2Data]					
	#set_property IOSTANDARD LVCMOS33 [get_ports present_state2Data]	
	#set_property PULLUP true [get_ports present_state2Data]
